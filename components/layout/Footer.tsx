...
const footerLinks = {
  ...
  Vendors: [
    ...
    { label: 'List a Venue', href: '/signup' },
    { label: 'Sell Products', href: '/signup' },
    { label: 'Offer Services', href: '/signup' },
  ],
  Support: [
    { label: 'Help Center', href: '#' },
    { label: 'Contact Us', href: 'mailto:support@spotly.in' },
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-10">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="text-2xl font-extrabold text-white mb-3 inline-block">
              Spotly
            </Link>
            <p className="text-sm leading-relaxed mb-6 text-gray-400 max-w-xs">
              India&apos;s all-in-one digital marketplace for properties, venues, fashion, cloud
              kitchens, and home services.
            </p>
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-6 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-gray-500">
            © {currentYear} Spotly Technologies Pvt. Ltd. All rights reserved.
          </p>
